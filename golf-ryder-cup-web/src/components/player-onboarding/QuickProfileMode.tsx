        ...
        >
            ...
            <div className="text-center">
                <motion.div
                    ...
                    className="w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 mx-auto mb-4 flex items-center justify-center shadow-lg shadow-amber-500/30"
                >
